...
// Function for creating issue card
...
const displayIssueCards = (issues) => {
    ...
    //Issues card generator
    issues.forEach(issue => {
        console.log(issue);

        // Border color determination based on issue status
        const borderColor =
            issue.status === 'open'
                ? 'border-green-700'
                : 'border-[#A855F7]';
        ...
        // Creating new card element for each issue
